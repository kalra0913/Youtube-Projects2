...
function Navbar() {
  ...
  return (
    <div className="flex overflow-y-hidden justify-between fixed max-h-20 top-0 w-[100%] bg-white px-6 py-2 ">
      ...
      <div className="flex  space-x-5 items-center ">
        ...
        <img src={profile} className=" aspect-square rounded-full h-8 w-8"/>
      </div>
    </div>
  );
}
